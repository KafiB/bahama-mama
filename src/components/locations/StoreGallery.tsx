            ...
            <div className="max-w-[1400px] mx-auto px-5 md:px-14">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {categories.map((cat) => (
                        <button
                            key={cat.id}
                            className="group flex flex-col items-center justify-center gap-3 bg-[#2a1200]/70 hover:bg-[#3a1800]/80 border border-white/[0.07] hover:border-[#FFBE32]/30 rounded-xl py-8 px-4 cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(0,0,0,0.4)]"
                        >
                            {/* Icon */}
