        ...
        <section className="relative bg-gradient-to-br from-[#120400] via-[#2a0800] to-[#1a0400] py-20 overflow-hidden">
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-5 md:px-14 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                ...
                <div className="flex flex-col items-start text-left w-full">
                    {/* Headline */}
                    <h2 className="text-[34px] md:text-[44px] lg:text-[48px] font-black uppercase leading-[0.95] tracking-tighter mb-4">
                    ...
                    {/* Subtext */}
                    <p className="text-[13px] md:text-sm text-white/60 leading-[1.6] mb-10 max-w-[480px] font-medium">
                    ...
                    <div className="flex flex-col sm:flex-row w-full max-w-[640px] items-center gap-3 mb-6">
                        ...
                        <button 
                            type="button"
                            onClick={handleLocationClick}
                            className="h-[54px] rounded-full bg-gradient-to-r from-[#FF5100] to-[#FF9000] text-white text-[13px] font-black uppercase tracking-[0.08em] hover:brightness-110 transition-all shadow-lg w-full sm:w-40 px-6 shrink-0"
                        >
                            Search
                        </button>
                    </div>
                    ...
                    <Link
                        href="/locations"
                        className="text-[12px] font-bold text-white uppercase tracking-[0.1em] border-b-[1.5px] border-[#FF6B00] pb-0.5 inline-block transition-opacity hover:opacity-80 translate-x-2"
                    >
                        View All Locations
                    </Link>
                </div>
